        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    <a class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" href="{{ route('todo.edit', $todo->id) }}">編集</a>
                </td>
                {!! Form::open(['method' => 'delete', 'route' => ['todo.destroy',
                $todo->id]]) !!}
                <td class="border px-4 py-2">
                    <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">削除</button>
                </td>
            {!! Form::close() !!}
            </tr>
        @endforeach
